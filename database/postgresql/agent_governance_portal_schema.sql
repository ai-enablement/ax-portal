...
insert into role_action_permissions (app_role, action_code, action_name) values
  ...
  ('team_member',  'GALLERY_SUBMIT',          '본인 제작 Agent Gallery 등록 신청'),
  ('team_member',  'GALLERY_PROXY_SUBMIT',    '타인 제작 Agent Gallery 대리 등록'),
  ...
  ('team_leader',  'GALLERY_SUBMIT',          '본인 제작 Agent Gallery 등록 신청'),
  ('team_leader',  'GALLERY_PROXY_SUBMIT',    '타인 제작 Agent Gallery 대리 등록'),
...
from users u
left join project_members pm on pm.user_id = u.id and pm.ended_at is null
