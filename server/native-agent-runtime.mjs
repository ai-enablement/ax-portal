...
export function runNativeAgent(packet,{env=process.env}={}) {
 return new Promise((resolve,reject)=>{
  const child=spawn(/* turbopackIgnore: true */ env.PORTAL_AGENT_PYTHON || 'python3',['server/vendor/intake-agent/portal_bridge.py'],{windowsHide:true,env:{...env,PORTAL_AGENT_EMBEDDED:'1',PYTHONIOENCODING:'utf-8'},stdio:['pipe','pipe','pipe']});
  let output='';
