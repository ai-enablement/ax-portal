...
export default function MarkdownDocumentWorkspace({project,phase,canEdit,devRole}:{project:{no:string;name:string};phase:Phase;canEdit:boolean;devRole?:string}) {
