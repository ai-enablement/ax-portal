...
export function automaticTrackReady(input?:ClassificationInput): boolean;
export function withAutomaticFeaTrack<T extends ClassificationInput>(input?:T): T&{track?:'LOW'|'MEDIUM'|'HIGH'};
