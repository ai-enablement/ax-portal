export type FieldValue = string | boolean[] | Record<string, string>[];
export type DocumentField = { id: string; label: string; kind: string; options: string[] };
...
export function hydrateStandardDocuments(stage: number, record?: Partial<StandardStageRecord>, project?: { name?: string }): StandardStageRecord & { documents: Record<string, StandardDocument> };
